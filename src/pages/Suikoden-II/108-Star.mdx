...
### Changelog
#### 2/17/24
- Move Chaco's Take from Bag Bolt Scroll to 2nd Zombie fight. Can now skip if Sheena has good MGC.

#### 2/3/24
- Clearer language for Highway Trading Shop
...
### TODO
- ~~Figure out how to avoid "forced" battle in Muse during Matilda~~ It's a random battle.
