...
##### Eilie
- Medicine > Firewall
- Gloves > Jowy's Medicine (l X)

##### Hero
- Medicine Slot 1 > Flaming Arrows
- *(For Safe Mist Monster)*: Gloves > Jowy's Flaming Arrows (l d X)
...
##### Equipment
 - Eilie: Empty Accessory > Jizo, 2nd Accessory > Luc Bolt of Wrath (l 2d X)
...
##### Buy
- 3 Native Costume
- Deer Antler (if in stock)
- **If All Worst SW Buys and no Deer Antler** 8 Sugar
...
- Fire Lizard
- Poison
- Can sell Wakaba's Head Gear & Belt of Strength for money. Want about 70000?
...
##### Withdraw (u X)
 - Karate Uniform > Nanami(d X 2d X Tr)
 - Magic Ring > Luc Slot 2 (3d X u X d X)
 - Skill Ring > Nanami Slot 1 (d X 2d X)
