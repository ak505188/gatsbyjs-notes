...
Go to Trade Shop. After 12 minutes and 33 seconds have passed from exiting the previous trade dialogue, talk to the trader.
...
##### Buy
- **5** Escape Talisman (For McDohl sidequest)
...
This whole segment of the notes is for Clive and McDohl sidequests.
...
Blinking Mirror. Teleport to Muse (d5)

### Muse
Set Text Speed to Slow
Go to Jowston Hill for Clive Quest
Blinking Mirror, Teleport to L'Renouille (r2 u2)
Run to Sajah Village.
...
Blinking Mirror, Teleport to Banner Village (r2 d3)

### Banner Village
Go to Gremio. Talk to Ko, Option 1. 
Go to Gremio. Talk to McDohl.

McDohl replace Clive (Slot 3). Don't change formation.

Go to Banner Pass. Talk to Ko's body.
...
After the cutscene switch text speed to Slow.
Run to Varkas.

After meeting with Lepant, leave the palace.
After leaving McDohl's house, go to Palace. Option 1.
Go south to leave Banner Pass.

Switch text speed to Fast, leave and Blinking Mirror.

Go to the Tavern, talk to Leona.
...
Teleport to L'Renouille (r2 u2)

Follow notes from Lucia 3 from here.
...
74. Banner Village
75. Banner Pass before Worm
76. Castle Leona party menu
77. L'Ren before S&C
78. L'Ren before Beast Rune
79. Castle
80. Tenzan Pass before duels

### Glitch Exhibition
#### (1-2) North Sparrow Pass Escape Talisman
1. Have guards not let you in, then Escape Talisman and run past them.
2. Load next save and show lady's dialogue

#### (3) Coronet OOB
1. Get on top of the roof/bookshelf, left up then right.
2. 10 steps left, then hold up
3. Make sure to show Eilie's "I'm the person who saved RPGLB's life."

#### (4) Hans Armor Glitch
1. Load **Save 4**:
2. Buy Scalemail, select Riou
3. Cancel sell or bag
4. Buy for Flik
5. Buy for Sheena
6. Back out, should have 999999 potch

#### (4) Castle OOB Glitch
1. Continue from Hans save
2. Run to bottom wall, go right. **WALK** down to go OOB. 
3. Run around to relevant building
4. Run into right wall for alignment.
5. Run down step by step. Once visible for 2-3 steps, run up.
6. Run to Radat

#### (5) Matilda Glitch
Push gate.

#### (6) Damage Overflow Glitch
[Spreadsheet](https://docs.google.com/spreadsheets/d/1LRXvBVz-SdhuWNXZrcVPgY4f1trrsJp-vzeKJLRFbOY/edit#gid=0)

##### Turn 2
Servant Attack Bon Bon (Sleep). Does Real 18000 damage

##### Turn 3
Servant Attack Bon Bon (Non-sleep). Shows heals for ~4000, real damage about 37000 heal.
Stallion Sunomuno Bolgan.

##### Turn 4
Servant Attack Bon Bon (Sleep) Damage shows 8544, Real damage is about 73000.
Stallion Sunomuno Bob.

##### Turn 5 & 6
Show that the BonBon doesn't die, hit it with party a few times.

#### (7) Tinto OOB
#### (8) Two River Kobold OOB
#### (9) Banner Pass OOB
#### (10) Kyaro Cutscene Skip
#### (11) Lucia Greenhill Trigger
#### (12) Amada early recruitment softlock

---

#### Saves from bottom to top
1. North Sparrow Pass before glitch
2. Kyaro next to army name lady
3. Coronet after dock before Rikimaru
4. Hans + Castle OOB Glitch
5. Matilda Glitch
6. Damage Overflow Glitch
7. Tenzan OOB
8. Tinto OOB
9. Two River Kobold OOB
10. Banner Pass OOB
11. Kyaro Cutscene Skip
12. Lucia Greenhill Trigger
13. Amada post duel
