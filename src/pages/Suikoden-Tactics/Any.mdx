 ...
 * Andarc: Flame, Water, 2 Lightning
 * Seneca: Flame, Water, Lightning
 * Walter: Flame
...
##### Outfitter (Try On)
 - Seneca: Thunder God Garb (if not owned). 3 Lightning, 3 Wind.
 - Kika: 2 Wind, Lightning
 - Flare: 2 Fire, Water
 - Trishtan: Fire, 3 Wind, Water, Earth
 - **Other Bead requirements:**
   * Kyril: Fire
   * Andarc: Fire, Lightning, Water
...
##### Outfitter (Try on)
 * Kyril: Mother Earth, Thunder, Flowing x3
 * Andarc: Thunder
 ...
 * Seneca: Power Glove, Cyclone Force Bead x4
 * Fredrica: Rage Robe, Power Gloves, Rage Force Bead x3
 * Fast #1: Mother Earth Bead, Flowing Force Bead
...
<PartyFormation formation={[
  { name: 'Millay (K)', x: 0, y: 0 },
  { name: 'Seneca', x: 1, y: 0 },
  { name: 'Trishtan', x: 2, y: 0 },
  { name: 'Kyril', x: 0, y: 1 },
  { name: 'Busk', x: 1, y: 1 },
  { name: 'Fast #2', x: 2, y: 1 },
  { name: 'Fast #1 (WO)', x: 3, y: 1 },
...
##### Turn 1
 ...
 - **Millay**: **9** Down, Mother Earth Bead 1 Right 3 Down (Bottom Left Spearman). **Extra Move 1 Up.**
 ...
 - **Kyril**: 6 Down. (Consider giving him a Water tile to buff Simeon).
 ...
 - **Busk**: Mount Kangacorn, move down. Swap to someone useful and do something useful. Probably Kika for archer kill.
 - **Trishtan**: Mount Kangacorn, move down, Switch to Simeon and nuke something.
...
##### Turn 2
 - **Seneca**: 4 Up. Wind / Cyclone Force Bead self. When group spawns here Dance of the Hawk.
