...
- Millay: Mother Earth Armor, Rage, M. Earth x2
...
- **Ornela**: 6 Up 1 Right, Rush Blue Spearman. Extra move 1U1R face up or right
...
- **Ameria**: Mount Owl, 9 Forward onto water tile. Switch to Corselia. Explosion Eye Fish. Try to kill only Eye Fish, killing only 5 units prevents extra cannon spawns.
...
Order supposed to be Ornela > (Fishskas, Millay) > Fredrica > Eye

##### Strategy
- Ornela: 7 Right, Mother Earth Bead 4 Right under Fishskas
- Millay: 7 Right 2 Up. Switch to Simeon & Flowing Force 1 Down 1 Right
