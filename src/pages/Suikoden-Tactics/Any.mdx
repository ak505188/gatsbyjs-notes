...
##### Outfitter (Try On)
- Seneca: Thunder God Garb. Wind x4
- Kika: Fire, Water, Lightning
- Mizuki: Fire, Earth
- Flare: Fire x2, Water, Wind
- Trishtan: Fire, Earth, Wind
- Pablo: Wind
...
- **Andarc**: If Kika already attacked Martin move up & Thunder Runner. Else, Standby so you can move before Martin T3.
...
- **Kangacorn Riders**: Mount Kangacorn, go to places to place tiles, switch to Kika / Seneca and Rage Force Bead.
   ...
   - Can swap to Akaghi for 3rd bead.
...
- **DO NOT PASS LINE FOR ENEMY AGGRO TRIGGER. AKA DO NOT PASS MILLAY + 1**.
...
- **Paula**: Forward **9**, switch to Millay. Mount **Red Owl**, **Giant Owl LVL2.**
- *Paula moving 9 forward here should manipulate Iskas to move 3L1D or 2L2D. As long as he doesn't move into corner you can hit from back anyway.*
