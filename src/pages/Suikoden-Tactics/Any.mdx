...
##### Turn 2
- **Kika**: 2 Up 4 Left, Falcon Thrust Archer if there else Standby.
- **Seneca**: If a fish survived, Strong Arm it from Lightning Tile to hopefully kill. Face in a direction so the fish doesn't block an important tile.
- **Millay**: 5 Up 1 Left, Standby. If fish is still alive on this tile kill it and take it's place.
- **Other 3**: Kill fish, try to move to right. Doesn't really matter, don't worry about keeping any of bottom 4 alive.
