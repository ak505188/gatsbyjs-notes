...
##### Rune Master
- Buy Sword of Thunder
- Attach Sword of Thunder to Kyril
...
- **Edgar**: Kill a Pirate closer to Steele / Medicine **WITHOUT MOVING** ally if viable. If no movement he gets a 3rd turn.
...
#### Strategy
##### Turn 1
- **Andarc**: 1 Down 1 Right, Standby.
- **Seneca**: 1 Down 1 Right, Wind Bead self.
- **Kyril**: 1 Right 2 Forward, Lightning Force 1 Above Andarc. Face forward.
...
- Also heal Kyril, want him near full HP for next phase.
...
- **Kyril**: 3 Forward, Flame Force Bead under self. **Face Back**.
- **Seneca**: Standby.
- **Andarc**: Standby.
...
#### Strategy
##### Turn 1
- **Kika**: 2 Right 1 Down, talk to Nalleo. (Seems to manip good Elemental Position).
- **Nalleo**: Kill Elemental / Standby.
- **Seneca**: 2 Left 3 Forward, Standby face forward.
- **Andarc**: 2 Left 3 Forward, Lightning Force 1 Right 3 Up.
- **Kyril**: 6 Forward, Standby face forward.
- **Dario**: 1 Left 2 Forward, Standby face forward.

##### Turn 2
- *Left Side is just improve and kill slowly and safely.*
- *Strats can adjust based on elemental movements, prioritize killing those.*
- **Seneca, Kyril**: Standby
- **Dario**: Can heal Kyril if needed.
- **Andarc**: Cohort, Extra Move forward.

> If setup worked properly, should have hit 4. Won't always though, depends on enemy AI.
...
##### Turn 4 & on
Place Wind & Lightning Beads under future unit spawns. **WANT WIND FIRST!**
Kill elementals, get into position.
...
##### Outfitter (Try On)
- Seneca: Thunder God Garb. Wind x2, Earth, Flame
- Kika: Flame, Water, Lightning
- Flare: Water, Wind
- Akaghi: **Water x2**, Flame
...
##### Rune Shop
- Buy Gale, Sword of Cyclone
- Attach Sword of Cyclone to Kyril
- Attach Sword of Thunder to Seneca
...
- *Experimental: From Kyril's Dying Wish Tile have him Flame Bead 3 Up 1 Right. Helps with Mage AI. Don't hit him till he moves there?*
...
1. Kyril -> Andarc
2. Switch Flare -> Millay (R1 1D)
3. Trishtan -> Seneca
4. Trishtan -> Pablo
5. Top Right Slot -> **Akaghi** (R1 1D)
6. Cancel Kika
7. Cancel Pablo
...
- **Akaghi**: Move forward, place Water Tile under Martin. Don't block Kyril's path for Swallow.
...
##### Outfitter (Try On)
- Kyril: Gauntlets, Fur Cape, Wind x3, Flame, Water *Replace Razril Knight Token*
...
- **Gary**: Switch to Akaghi, 1 Right 3 Up. Water Force Bead 1 Right 3 Up. *If Simeon did Wind of Sleep on Officer, place Flame Bead under him instead.*
...
Money needed: 6000 + 15000 + 12000 = 33000. Sell if short.
##### Outfitter (Try on)
- Kyril: Rage x3, Thunder x2, Flowing
- Millay: Cyclone x1/2, Mega Medicine, Godspeed Anklet
- Pablo: Rage, M. Earth
...
#### Strategy
##### Turn 1
- **Seneca / Trishtan**: Move all the way left, 1 down from cliff. Switch to Pablo. Mother Earth Bead 1 Right 3 Up so there's tiles under Cannon and there's a tile Fredrica will be able to stand on.
- **Seneca / Trishtan**: Move to Earth tile left near cannon, switch to Fredrica. Strong Shot to kill.
...
##### Outfitter (Try On) - $11200
- Jewel: Rage x3
- Paula: Flowing
- Pablo: Rage Robe
- Fredrica: **Rage x2**, M. Earth
- Millay: Mother Earth Armor, Rage, M. Earth x2, Flowing
...
- **Seneca**: Switch to Ameria. 2 Right 4 Up (1 below center Fire Tile).
...
<PartyFormation formation={[
  ...
  { name: 'Paula (WO)', x: 1, y: 0 },
  { name: 'Seneca', x: 0, y: 2 },
  { name: 'Fredrica', x: 1, y: 2 },
]}/>
...
#### Strategy
##### Turn 1
- **Jewel**: Rage Bead 1 Down 1 Right. Extra move 9 Up.
- **Fredrica**: Switch to Simeon. Move 1 Right, Blazing Wall.
- **Paula**: Flowing Bead 1 Right. Extra Move 9 Up.
- **Seneca**: Switch to Pablo. 1 Down 1 Right, Rage Bead 4 Left.
- **Corselia**: Blazing Wall. Extra Move to up to Gate.
- **Kyril**: 3 Up, Rage Bead 3 Up (Under Mages). *If they're already on Fire Tiles, can go to bottom group and place Rage Bead there instead.*

##### Turn 2
- **Owls**: 9 Forward
- **Simeon & Corselia**: Blazing Wall.
- **Pablo**: Standby rest of fight.
- **Kyril**: Rage Bead under Soldiers & allies if possible. If possible can move onto Fire tile too, has no job rest of fight.

##### Turn 3
- **Jewel**: 9 Forward.
- **Paula**: 9 Forward, Dismount.

##### Turn 4
- **Jewel**: 5 Right 4 Forward, lined up with center shield. Rage Bead 3 up, 2 below fish.
- **Paula**: Mount Kangacorn, 8 Forward 2 Right. Switch to Kika, Rage Force 3 Up (1 Up 1 Left of fish).
- **Jewel**: 5 Forward 1 Up (between 2 right fish). Rage Bead 3 Up (2 above right fish). Extra Move 3 Right.

> Chance that Roget gets Shredding off here, depends on turn order. Fine regardless.

##### Turn 5
- **Jewel or Kika**: Switch to Millay, Mount Kangacorn, Rush Roget from right side.
- **Simeon & Corselia**: Blazing Wall after spawns.

#### Information
Even if you kill the 3 fish and Roget at the same time, the rest will still spawn.

#### Notes
Moving Millay/Paula/whoever out of Shredding range doesn't work, he Cyclone Forces the fish instead.
...
- Ornela: Strength Sash, M. Earth x2
- Paula: Godspeed Anklet
- *Tomes for Simeon and Pablo for safety*

##### Blacksmith - $33000
- Sharpen Kyril, Ornela, Millay, **Fredrica**

##### Rune Shop - $600
- Millay: Giant Owl over Gale
- Ornela: Gale, Kangacorn
...
#### Strategy
##### Turn 1
- **Millay**: 6 Up 1 Left, Rush Blue Spearman. Extra move 1 Left 2 Up, face right.
- **Ornela**: 6 Up 1 Right, Rush Blue Spearman. Extra move 1 Up 1 Right face left.
- **Jewel**: 9 Up (behind Red Swordsman), switch to Simeon. Silent Lake 1 Up 3 Left - Top left corner should be on top left staff wielder. Should hit fish and all staff wielders, and put Simeon on water. Face **back**.
...
- **Ameria**: Mount Owl, 9 Forward onto water tile. Switch to Corselia. Explosion Eye Fish. Try to kill only Eye Fish, killing only 5 units prevents extra eye spawns later.
...
- If you need more distance, Fredrica swap into Owl Mount is good.
...
#### Strategy
##### Turn 1
- **Ornela**: 9 Forward, Flame Bead under middle Red Soldier.
...
- **Fredrica**: 2 Left 6 Forward, Dismount. Strong Arm front Soldier.
...
- **Paula/Paula**: Move behind Simeon, switch to Pablo. Co-op **Bottom Left** Soldier. **FACE BACK**.
- *Pablo face back manipulates Archer to target him, avoids crit chance on Millay. It's okay if he dies.*
- **Kyril**: 2 Left 4 Up. Rage Force Bead on bottom middle of circle (4 Up).
- **Ameria**: Mount Kangacorn. 10 Forward, in front of Simeon. Switch to Corselia, Explosion 4 Forward, hit everyone but Archer.

##### Turn 2
 **No important character should end up on a Fire Tile**.
- **Ornela**: Rush Archer from back, move in front of Millay.
- *If there was a survivor kill instead, as long as you can get to right tile.*
- **Millay**: 3 Right 7 Down. Rage Bead under furthest Archer/s.
- **Fredrica**: Mount **RED OWL**. 4 Left 4 Down.
- **Lino**: Move in front of Ornela, Rage Bead under Archers. *If you need to go further, mount Owl and switch to Seneca. She'll die to Blazing Wall. Don't want anyone too close to back group for AI reasons.*
- **Simeon**: Blazing Wall.
- **Pablo**: Move off fire tile.
- **Kyril**: Swallow Ogre Breath Chest (Left chest)
- **Corselia**: Start casting Blazing Wall

##### Turn 3
- **Ornela**: Kill a survivor if any.
...
#### Notes
You can have Fredrica go 8 Forward T1 for the Strong Shot, this will let you skip the weapon sharpen. However, the red owl rider might move directly up instead ruining the Explosion.
...
#### Setup
<PartyFormation formation={[
  { name: 'Millay (K)', x: 2, y: 1 },
  { name: 'Fredrica', x: 2, y: 2 },
  { name: 'Ornela (RO)', x: 2, y: 3 },
]}/>

**REMOVE CORSELIA FROM FORMATION**.
Order supposed to be Ornela > (Fishskas or Millay) > Fredrica > Eye

##### Strategy
- Ornela: 7 Right, Mother Earth Bead 4 Right under Fishskas.
- Millay: 7 Right 2 Up. Flowing Force 1 Down 1 Right.
...
##### Strategy
 ...
 3. Standby, face towards it. If under 500 damage, move 1 tile towards it, Swallow LVL1, and move back to center.
