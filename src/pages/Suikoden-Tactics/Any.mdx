...
- **Kika**: Move towards Archers, Falcon Thrust Archer so Millay can back/side attack the other without losing movement.
...
- **Gary**: Move to Water Tile, switch to Coop and chill rest of fight. Can kill mages if needed.
...
- **Kika**: Move to left side of wooden ramp, Water Bead 1 Down 1 Left.
