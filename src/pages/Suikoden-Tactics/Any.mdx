 ...
 * Andarc: 2 Flame Force Bead, Water Force Bead, Lightning Force Bead
...
##### Outfitter (Try On)
 - Seneca: Thunder God Garb (if not owned). 2 Lightning, Flame, Wind, Water.
 - Kika: 2 Wind, Lightning
 - Flare: 2 Fire, Water
 - Trishtan: Fire, 3 Wind, Water, Earth
 - **Other Bead requirements:**
   * Kyril: Fire
   * Andarc: Fire, Lightning
...
##### Turn 1
 ...
 - **Kika**: Forward Max
 - **Seneca**: Forward Max.
 - **Andarc**: Forward 5, next to Seneca.
 - **Kyril**: Forward max
...
#### Strategy
##### Turn 1
 - **Trishtan**: 7 Down 2 Left, Rush Orange Fish **(NOT RED FISH)**
 - **Kika**: 4 Down 1 Left, Attack / Falcon Slash Red Fish. Extra move 1 Left or 1 Down.
 - **Flare**: 5 Up, Water Force Bead 1 down 1 right.
...
##### Turn 3
 ...
 - **Seneca**: 2 Down 3 Left, place Flame tile on center of Roget's Wind tiles.
 ...
 * Millay: Extra Move, Godspeed, Bull's Eye - B
...
#### Strategy
##### Turn 1
 - **Kika**: 4 Up 2 Forward, Wind Force Bead tile in front of her.
 ...
 * Millay: Battlelust - B, Equip Battlelust
...
##### Turn 2
 ...
 - **Andarc**: Move 1 back if needed to line up with Seneca. If Officer already moved, Flame Force tile below him.
...
Money needed: 7000 + 12000 + 20000 = 39000. Sell if short.
##### Outfitter (Try on)
 * Kyril: Mother Earth, Thunder, 2 Flowing, Rage
 * Andarc: Thunder
...
## A Parting of Ways
### Caravan
Depart, go to Small Border Village.
...
##### Outfitter (Try on)
 - Ornela, Kika, Millay: Mother Earth Armor

</Menu>

Depart, go to & enter Graska
