...
##### Outfitter (Try On)
 * Kyril: 2 Lightning Force Bead, Flame if you used one
 * Andarc: 2 Flame Force Bead, Water Force Bead
 ...
 * Maxine: Fire Magic - C
 * Seneca: Extra Move, Battle Lust - C (Do this last because Skill Points are tight)
...
##### Outfitter (Try On)
 - Seneca: Thunder God Garb (if not owned). 2 Lightning, Wind, Water.
 - Kika: 2 Wind, Lightning
 - Flare: 2 Fire, Water
 - Trishtan: 2 Fire, 2 Wind, Water, Earth
...
### World Map
If needed for money enter Caravan and equip Medals for selling.
...
##### Outfitter (Try On)
 * Millay: Wing Mail, Steel Shielf (if no Steele's Shield), Strength Sash, 2 Wind Force Bead (1 for later, 1 just incase)
...
##### Turn 1
 ...
 - **Millay**: 5 Up 3 Forward, up to Wind Tile 1 Up 1 Forward from Kika. Rush Fish if it's there.
 - **Corselia**: 4 Forward, Breath of Ice 3 Fish.
 - **Seneca**: 3 Up, Medicine / place bead or something to slow her down. Don't attack any of 3 front fish, Corselia needs to get the kill. If she's after Andarc can just standby after movement.
 - **Andarc**: Standby
...
##### Turn 1
 ...
 - **Andarc**: 4 Forward 1 Up, Place Fire Tile under top fish.
