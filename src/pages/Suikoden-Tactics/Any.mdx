...
##### Outfitter (Try On)
 - Kyril: Fire x2, Wind x2, Water
 - Seneca: Thunder God Garb (if not owned). Lightning x3, Wind x3
 - Kika: Fire, Water, Lightning
 - Mizuki: Fire x2, Earth
 - Flare: Fire x2, Water x2
...
Note: Pablo is assumed to be slowest character here, doesn't have to be Pablo but you need someone slower than everyone else here. Axel is a good replacement.
...
Mizuki needs Godspeed, Extra Move.
...
##### Turn 1
 ...
 - **Kangacorn 4**: Mount, 1 left of Seneca. Switch to Flare, Wind **Bead** 1 left of Trishtan.
