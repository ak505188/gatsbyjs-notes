...
## WIP
These are still a WIP, I wouldn't recommend using these if you aren't already familiar with the run.
...
> You have 3 usable Ice S, 1 Wind S, 1 Light S. 1 gets saved for C2S Provoke. Others can be used for Canalbrine battles / C3 LP setup
...
##### Jobs
- Throne: +Armor Corrosive +HP Thief, Merchant, +Donate BP +Hired Help
- Castti: Inventor
...
Run from small battles, kill Borderfall/Montwise with Tera.
Soothe Guard.
...
- Frost Moleking I x2, Plains Drake
- Albino Bat x4: Tera
...
Provoke: S Stone, Tera

#### Sacred Peak Altahe
Walk till 1st cutscene. Pick **Reinforcing Jam**.
...
2. HHG x4, if Throne needs LP use Osvald Staff and Castti Staff Catapult to knock off shields

> For HHB B3, need $63370 when doing HHG on B2

3. HHG x3, Tera (Think it's faster than Glacis)
