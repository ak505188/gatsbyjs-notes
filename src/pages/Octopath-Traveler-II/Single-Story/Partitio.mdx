...
After getting **Osvald**, warp **New Delsta Anchorage**.
...
- Agnea: +Stimulate
- Osvald: +Lightning Bolt +Analyze/Elemental Barrage
- Castti: +Poison Axe
...
##### Items
- Empowering Bracelet: Osvald
- Gorgeous Sari: Partitio
- Light L: Partitio

##### Jobs
- Osvald: Thief, +Armor Corrosive
...
##### Equipment
- Osvald: Remove Empowering Bracelet
...
- **Osvald**: If before Partitio can Armor Corrosive Engine if it got Reinforced, else Defend. If after Partitio, Sword x2 or AC.
...
- **Osvald**: Sword Attacks / AC
- **Castti**: Attacks

##### Turn 3
- Kill him with Partitio. If AC is needed and not applied, can Stimulate Osvald with Agnea to put him before Partitio.
- **Castti**: If doing HHB x4, Poison Axe

#### Sample Fight
*We'll assume turn order is Agnea, Engine, Castti, Partitio, Osvald. Assume Thurston did something harmless. And we're trying to save money for Bracelets.*
##### Turn 1
...
- Garnet: Once again, Partitio won't fill Latent unless he gets hit T1
...
#### Osvald Death Script
If you decide to greed and not give Osvald a Bracelet, and only Osvald dies T1 to Bite (before he gets his action), here's a backup. If it's after his action, can just have Agnea Ruinous Kick T2. Note that Partitio won't get to break to fill Latent.
...
## Changelog
### 2/23/24
- Properly remove Cape Cold from the notes (sorry Sanjan LOL)
- Add text to recruit Agnea
