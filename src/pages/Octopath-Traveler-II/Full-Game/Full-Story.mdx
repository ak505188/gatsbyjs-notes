...
- Oswald: Lion Dance Throne
- Agnea/Temenos: Pom L / Plum Throne
- Throne: **LATENT** Aebers, HP Thief x3
...
- Throne Start
- Alternate Exploration, later Temenos, get Castti earlier.
  * More characters recruited means better enemy groups to get EM
  * Throne with standard battles will likely be LVL7 in Conning Creek, which makes the Wind L Steal 15%
- Cut White Powder Quest
  * With JP Augmentor cut, we need 1 less M Stone. Can maybe afford stuff without quest now.
...
- Look into Vide kill, barely missed it once in practice (90k, 99k, 52k). 
  * Can probably fix with Summon Strength over Life in the Shadows
- Route in Flamechurch candle quest, to skip battles in Dusk segment.
- Test Assasins on Yomi, if you need HHB x3 or x4 on Partitio & Temenos 2 fights
- Look into Diamond Dagger purchase in Merry Hills
  * Money is the big concern
  * Not sure if the stats matter
