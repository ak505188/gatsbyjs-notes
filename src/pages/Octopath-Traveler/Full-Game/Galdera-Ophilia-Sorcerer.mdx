...
## Update 2/12/22
I've updated these notes with quadraacep's changes to the route (Force Shield skip, early H'aanit) along with some menu order optimizations and whatnot. I only looked at the Cait route, although I think all the changes apply to both routes. 

I also recommend using [quadraaceps's Notes](https://docs.google.com/document/d/1lPwOckVpeMikfvulsHJl42WL2OlD3z-pN66PUrbpYJY/edit#), especially if you want to make your own changes. He's been running more actively and his notes are likely to be more up to date in the future. To my knowledge, he doesn't have notes for the Cait route so these are still of use.
...
##### Jobs
Tressa: **Scholar**, Lightning Bolt, Blizzard
...
Enter **Marsalim**, buy **ONLY Magic M** from guy by entrance near shop. Go to palace, buy 2 **Pom M** from left guard, purchase **Fire L, Wind L, Shadow L** from right guard. Pick **Enchanted Circlet, $25,000, High House Armor** in the three red chests in the room to the far right.
 ...
 * Alfyn: Spearhead + Thousand Spears, **Merchant**, Donate BP + Hired Help
...
Break Lizards with Bandits x2 and kill with a L Stone or Peacock + Lightning Blast x4
...
You want to have around $67000 to be safe.
...
##### Items
 * Tressa: Nourishing L
 * Ophilia: Magic L, Sharp M

##### Equipment
 * Tressa: -Adamantite Shield
 * Therion: Badge of Friendship
 * Alfyn: Optimize, Mighty Belt

##### Jobs
 * Alfyn: 2 Merchant Skills, **Warrior**
...
Complete quest (guy to the right) for **$15000** + **Revitalizing Jam**. Buy **Nourishing L, Tough L** from guy near right exit.
...
##### Skills
 * Tressa: -Endless Items -Heightened Senses, +Percipience +The Show Goes On
 ...
 * Tressa: Empowering Necklace, Elemental Heavy Armor
 * Therion: **-Empowering Bracelet**
 * Alfyn: -Mighty Belt +Empowering Bracelet (Optional)
 ...
 * Therion: Empowering Bracelet (Optional)
...
##### Turn 2
 * Ophilia: Ignis Ardere x4
 * Cyrus: Healing Grape Self / Attack
 * Tressa/Therion: Donate BP x3 Ophilia **(CHECK CURSOR AFTER CYRUS GRAPE)**

##### Turn 3
 * Ophilia: Ignis x4 (if LV30) / Lux Congerere x4
...
##### Equip Skills
 * Ophilia: Elemental Aid + Stronger Strikes
...
#### Ghisarma (72 SP)
 * Glacies x3 or x2 + L Stone

TP **Bolderfall**.

Optionally Steal Pom L from Alphas. Provoke Alphas and use Fire L or Shadow L.

TP **Saintsbridge**.

### Alfyn Ch.3 Start
Optionally pick **Pom M** after cutscene. Steal **Poms** from guy by screen transition.
Go to Tavern, trigger cutscene. After cutscene TP **Wellspring**.

### Therion Ch.3 Start
Go to Tavern, Steal **Bottle of Wine**.

Talk to Tavern Keeper, swap Tressa > H'aanit.
Continue story, after cutscene at Black Market TP **Saintsbridge**.

### Alfyn Ch.3 Continued
Talk to Lyblac. Inquire Alphas. Proceed with story.
Inquire lady for story. Finish Daughter of the Dark God II.
Go into the church, purchase **Battle-Tested Staff**.
TP **Wellspring**.
...
##### Items
Heal Ophi SP if needed

##### Equipment
 * Therion: Gideon's Dagger (optional), Adamantite Shield, -Badge of Friendship +Empowering Bracelet (x2)
 * Ophilia: Optimize, -Unerring Bracelet +Empowering Necklace
 ...
 * Alfyn: Injurious Seed + Essence of Grape / Wind L / Pom M Ophi
 * Therion: Defend / Donate BP
 * Tressa: Peacock Strut
 * *If Ophi first, Glacies x2 + Wind L to kill adds.*

##### Turn 2
 * Ophilia: Ignis x4
 * Merchant: Donate BP x3

TP **Wispermill** and head to **Shrine of the Starseer**.
 ...
 * Alfyn: -Endless Items +The Show Goes On
...
> 3. Set up turn 2 Aelfics. You need to Pom Therion & defend with him if he's after Ophilia. Worst case, you can Soothing Seed + Curious Bloom Therion to put him before Ophilia.
...
> Pay attention to Ophi's JP after this fight.
> If < 2630, need to kill something in Alfyn 4 / Warbringer
> TODO: Threshold for BP Eater
...
Optionally pick **$30000**, based on money / if you need encounter.
 ...
 * Ophilia: Elemental Break
 * Therion: Defend
 * Alfyn: Soothing Seed + Curious Bloom **Tressa** / Panther Dance if learned & puts Tressa before Ophilia / Nothing
...
Mandatory fight: Ophilia Luminescence / Tressa Fireball x2 / M Stone
...
##### Support Skills
 * Therion: -Endless Items -The Show Goes On +Boost-Start +Hard Worker
...
After the fight, TP **Saintsbridge**. Purchase **Fort L** from Tim.
TP **Victor's Hollow**, finish the chapter.
 ...
 * Olberic: Unequip all
 * Therion: **Remove Dagger**

</Menu>

144 SP Ophilia, Ignis x2 both Lizard fights

> Ophi needs at least 7400JP after Lizards, else take an extra fight here or in Olberic 4.
 ...
 * Olberic: 3 Merchant Skills, **Warrior**, 2 Skills, **Thief**, 3 Skills
 * Tressa: **Starseer**, 4 Skills, **Scholar**

##### Support Skills
 * Ophilia: -Augmented Elements -Stronger Strikes, +BP Eater +Boost Start 
 * Tressa: -The Show Goes On, +Boost Start
 * Olberic: Fleetfoot, Cover, Hang Tough
...
Inquire Bishop Donovan in the cathedral.
TP **Wellspring**.
...
##### Equipment
 * H'aanit: Optimize, Empowering Bracelet x2
 * Therion: Battle-tested Blade, Captain's Badge, Empowering Necklace
 * *If needed, Lizard King Axe to H'aanit*
 ...
 * Ophilia: Elemental Break
 * H’aanit: Defend
 * Therion: Holy Light / Nothing if Ophi before Dragon T2
 * Tressa: Defend
...
##### Tavern Equipment
 * Primrose: Unequip all, Unerring Bracelet
 ...
 * Cyrus: **Merchant**, 4 Skills, **Hunter**, Leghold Trap
 ...
 * Therion: -Adamantite Shield, -Empowering Necklace +Mighty Belt (Viper Dagger if not done earlier)
 ...
 * Cyrus: All Scholar Skills, **Dancer**, Peacock + Mole
