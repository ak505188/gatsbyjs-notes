...
Pick **Old Coin**, tag **Bolderfall**. Get **Hunter Shrine** + **Olive L**.
...
##### Items
 - Nourish S: Therion
 - Plum Olberic (Can skip under certain conditions)
 - *If Olberic will level off first Challenge, you can skip this. 
 - *If he leveled anywhere Ravus Manor and now, you need to Plum him after 2nd Challenge.*

##### Jobs
 - Olberic: **Warrior**, <strong style={{ color: 'red' }}>Cross Strike</strong>, **Scholar**
 - Tressa: Hired Help, **Hunter**, Leghold
...
##### Turn 1
 - Olberic: Defend x2 / Defend
 - Tressa: Defend
 - Therion: Pom M Olberic / HHM (HHM version is better)

##### Turn 2
 - Olberic: Staff x3 [L]
 - Tressa: Axe x3 [R]
 - Therion: HHV x3 / Defend
 - *HHV early safer because you kill the adds.*
...
##### Jobs
 ...
 - Tressa: **Merchant**, Sidestep, **Hunter**
...
T1: HHVx2, Thousand Spears, Leghhold
...
> Pom M if we used 1 in Ch.2 need to buy here.
...
> 11JP: Old Man (3rd NPC we talk to for quest): XS x2
>
...
Notation is: Therion before / after LK

#### T1
 - Olberic: Leghold / Attack x2 if you can break him before his turn T2 and no adds spawned yet
 - Tressa: LB / Wind L if Therion before & Tressa after
 - Therion: HP Thief / Wind L
 
#### T2
 - Olberic: Attack x3 / Cross Strike if adds alive
 - Tressa: Defend / Lightning Blast
 - Therion: Armor Corrosive
...
*Weak: Axe, Wind, Light*
##### Turn 4
 - Olberic: Heal Self / Herb of Valor
 - Tressa: Pom M Self
...
##### Turn 5
 - Olberic: Attack x3
 - Merchant 1: HHB x4
 - Merchant 2: Rev Jam Merchant 1 (Ideally this is Therion)
