...
> Assuming 2T Cait (-15), Ravus Manor worst battle and ambush, and Quarrycrest ambush (-5) you are short 13JP for Leghold. You can still win without it, but you're limited to 6T scripts as 9T require Leghold, and you lose some options for 6T.
...
Tag **Riverford**. Go to towards **Refuge Ruins** and pick **Wind L** along the way.
Pick **Forbidden Blade**, **Enchanted Rod**, **Force Shield**.
...
> 10/11JP: Cervantes right guy in front of Tavern: XS x2. Can miss the crit, which means you only get 10JP with a T2 kill. Can also just throw a M Stone if you have a extra.
...
Pick **Silver-filled Pouch** in Lord's Manse before warping back to **Riverford**.
...
> There's 3 main opens to consider. The one in notes is the default.
> 2nd one is Olberic Defend x2, Thunder M, Rev Jam.
> 3rd one is Merchants Sidestep (if both requires Leghold)
> You should choose the open based on T1 turn order.
> I'm not going to cover all scenarios here, but here's a [link](https://docs.google.com/spreadsheets/d/1vJeghl_L_KTCaCBNBJtCcZa2ocLllJrFX3aIvvXhKFQ/edit#gid=1078495202) to my spreadsheet scribbles that goes over them.
>
