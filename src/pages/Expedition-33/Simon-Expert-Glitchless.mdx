...
### Continent
Pick up **Colour of Lumina** on the way to fight.
...
##### Pictos
- Maelle:
  * +Auto Powerful > Immaculate
  * +First Offensive > Confident Fighter
...
- Sciel:
  ...
  * +Stun Boost
- Maelle:
  * +Confident Fighter > Painted Power
...
##### Turn 0
- Verso: Attack Middle > Shoot Right 3 times, Leadership
- Maelle: Last Chance
...
### Camp
Talk to Esquie till Relationship LV5
...
##### Turn 0
- Verso: Attack Stalact > Shoot right 3 times, Defiant Strike Stalact
- Maelle: Last Chance
- Sciel: Intervention Maelle
- Maelle: Phantom Strike
...
##### Upgrade Attributes
- Maelle: +33 Might (83) *Putting into Defense gives more, but isn't necessary.*
...
- Verso:
  ...
  * +Second Chance
- Maelle
  * (Triangle) +Cheater > First Offensive
