...
- Old Lumiere: Not sure, probably best to do part of the menu before Stalact, and rest after party split. Or split the Statalct Picto menu and do part of it before the flag, and reload the autosave.
- Sirene: Either flag at camp, or before Glissando.
...
> Parries on Abbests are optional, assuming you don't need Gustave Charge.
