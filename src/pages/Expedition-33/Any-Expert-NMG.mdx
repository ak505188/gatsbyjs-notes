...
Last update: 12/20/25.

**Patch update 12/11/25**: This patch removed the extra 10% damage on First Strike and Dead Energy II, which breaks this route. This route assumes that you use the patch before it, 57661. Anything before that would work, and optimal patch would be the one before Stendhal nerf. However, if running on pre-Stendhal nerf, the Renoir 3 strat would need to be adjusted.

These are my preferred [downpatch instructions](https://steamcommunity.com/sharedfiles/filedetails/?id=1086279994).
...
Load most recent save, interact with flag.
...
<Menu timing="Cutscene entering Goblu">

##### Skills
- Lune: Remove Thunderfall
...
##### Turn 1
- *Parry 2 hits, dodge 1*
- Lune: 2 Shots, Wildfire
- Gustav: Powerful
- Maelle: Swift Stride
...
- Lune: Immolation
- Gustav: Overcharge
- Maelle: Can shoot till 4 ATB, Swift Stride

##### Turn 4
- Lune: Can shoot all ATB, Attack
- Gustav: Can shoot till 3 ATB, Marking Shot
- Maelle: Percee

If still alive, do Turn 4 again.

There's also a different version you can do when you see you'll be short on damage.
T3: Lune Wildfire, Gustave Powerful, Maelle optionally shoot flowers, Offensive Shift. Then continue the fight from T3 in the script above.
...
If not done earlier, can use flag before Ultimate Sakapatate or just skip it entirely.
...
##### Upgrade Attributes
- Maelle: _If no upgrade in Ancient Sanctuary_ +12 Might (29)
...
_If you got extra Polished drops, you can skip purchases here and cut out later money pickups._
##### Buy
...
##### Learn Skills
- Lune: Lightning Dance _Should auto-equip to Left-Bottom_
...
### The Continent
Head towards the Demineur, Lancelier, Crueler. Dismount as close as possible.
Pick **Colour of Lumina** and First Strike the group here.
...
Pick up **$1775** near Chromatic Bruler.
...
<Menu timing="After First Strike, before Lampmaster">

_You can split this menu between different jumps._
##### Pictos
- Lune:
  * +Critical Moment
  * +First Strike
...
<Menu timing="Cutscene entering Lampmaster">

##### Pictos
- Maelle: -Dead Energy II
...
> The fight here is the consistent version, there is a faster but much more luck based version. 
> The luck based version will be in the [bonus strats section](#fast-dualliste-71106hp-140215) of the notes.
...
##### Pictos
- Verso: (Triangle) +Combo Attack > At Death's Door
...
##### Turn 0
- Verso: 
  * Shoot Mine then shoot Demineur 3 times. _If you miss once, make one of the shots a head shot._
...
Dodge his Attack. _Bonus: If you build 2AP for Lune via parries/dodges, you can skip the Energy Tint_
...
##### Upgrade Attributes
- Lune: Recoat, +11 Might, +37 Agility, +12 Luck
...
- Verso: If left Chevaliers survived, shoot left Chevaliers once then shoot right Chalier twice, Berserk Slash. If dead, Attack > Berserk Slash
...
- Sciel:
  * +Auto Rush
- Lune:
  * (Triangle) +Confident Fighter > At Death's Door
...
##### Turn 1
- Verso: Energy Tint Sciel / Leadership if low damage and you need Lune shots.
- Lune: (If damage low shoot up to 4 times), Wildfire (Finish Phase)

#### Mask Keeper 185114HP (1:55)
...
_Bonus: If he attacks the expedition, you can parry 3 times (2 with Leadership T1) and do Powerful instead of Attack > Leadership._
...
##### Upgrade Weapons
- Sciel: Scieleson +3 (8) _If you have enough for 9, go to 9_.
- Lune: Lighterim +4 (13)
...
_Bonus: You can skip Verso Attack Turn 0, but will likely need extra damage T1. Practice to learn the thresholds before attempting._
...
Turn 1: Shoot as needed for damage.
...
_Bonus: If you got Scielson LV9, you can equip Lanceram for this fight and skip both Verso Attacks. If Verso didn't crit the counter, add 2 shots with Sciel. If you still have the Dualiso, you can cut the 2nd Attack but not the first._
...
_This one is optional and only relevant for Renoir 2_
##### Lumina
- Verso: +Critical Moment

</Menu>

<Battle>

#### Renoir 2 370890HP (1:07)
...
##### Turn 1
- Verso: Attack > Powerful _You can skip the Attack here with counter damage._
- Sciel: Sealed Fate
- Lune: Ice Lance
...
##### Lumina
- Sciel: (L2) +Energising Start

</Menu>

<Battle>

#### The Paintress 482157HP (4:06)  
...
_Bonus: If you counter both moves, you can skip the T2 Verso Attack. Saves ~2s_
...
##### Turn 1
- Lune: Skip / Attack if Paintress healed Verso and not S-rank.
- Verso: Defiant Strike
- Sciel: Sealed Fate
...
> 56 Might is the minimum, would need perfect QTE on Virtuose Strike. You can throw all remaining points into luck.
...
## Changelog
##### 1/02/26
- Update title from restricted to glitchless
- No longer link Deminerim notes
- Add information about DLC patch and downpatching
- Add information about cutscene menuing
- Menus now have different colors from battles
- Menus updated to take advantage of cutscene menuing
- Menus now have information about when to do them
- Menus are generally split up into smaller ones to take advantage of cutscene menus
- Manor now has Maelle skill menu (gets you Swift Stride left-bottom)
- Teach Lune Electrify early (skips manual equip of Lightning Dance)
- No counter opening for Goblu
- Add "backup" strat for Goblu
- Cutscene menu to equip Sakaram before Ultimate Sakapatate
- Moved fast Dualliste strat to bonus strat section at bottom of notes
- Correct some names
- Mask Keeper: Use Energy Tint instead of 1st Leadership (unless bad damage)
- Sirene Ballet fight now swaps weapons and uses Perfect Recovery to kill Verso
- Added bonus for Sirene fight if Scielson LV9
- Added note to optionally cut T1 Verso Attack on Renoir 2
- Added bonus for Paintress P2 where you counter both moves and skip Verso's 2nd Attack

##### 8/31/25
- Move Sirene flag to camp (just in notes, no route change)
...
##### 6/27/25
- Improved Dualliste mediocre strat. Consistent now, Lune doesn't need to Ice Lance.
