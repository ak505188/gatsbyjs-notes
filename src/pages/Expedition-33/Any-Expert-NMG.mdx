...
##### Buy
- 3 Polished Chroma Catalysts
- 2 Resplendent Chroma Catalysts
...
- Lune: Deminerim +4 (13)
- Sciel: Scieleson +4 (9)
- Verso: Dualiso +1 (10) - I think this can be cut.
...
- Sciel: +Sealed Fate
- Sciel: Equip Sealed Fate Bottom-Left
...
##### Turn 1
- Verso: Attack if needed for B rank, Leadership
- Lune: Elemental Trick (Fail QTE)
- Sciel: Rush
...
##### Turn 2
- Verso: Shoot till near A rank (should be 6 shots), Attack > Powerful (want A rank duration bonus)
- Lune: Lightning Dance
...
- Maelle: +12 Might (65) +18 Luck (18). If short, the luck is more important.

##### Learn Skills
- Maelle: +Stendhall, +Last Chance
- Maelle: Equip Last Chance Left-Bottom, Equip Stendhall Left-Middle
...
##### Pictos
- Sciel:
  * +Weakness Gain > Immaculate (No Swap)
  * +Energy Start I > Confident Fighter
- Maelle:
  * +Painted Power
  * +Immaculate
  * +Confident Fighter
...
##### Turn 0
- Maelle: Last Chance
- Sciel: Rush **Select Sciel, Fail QTE**
- Verso: Powerful

> Sciel should go before Renoir

##### Turn 1
- Sciel: Intervention Maelle
- Maelle: Stendhall

Phase transitions here, order should be Renoir > Verso > Sciel.
Dodge Renoir's attack.
