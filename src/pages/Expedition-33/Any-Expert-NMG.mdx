...
Last relevant update: 6/03/25
**This had a lot of changes, check the changelog at the bottom**.
...
- Maelle: Equip Stendhall Left-Middle, Equip Last Chance Left-Bottom
...
- Old Lumiere:
  * Sciel gets 15 more Might instead of Luck now. 
