...
**Last update: 6/15/25**: This is a big one, replaces Lighterim with Deminerim. Read the changelog!
...
##### Upgrade Attributes
- Gustav: +2 Might (13) +13 Agility (20)
- Maelle: +6 Might (32)
...
Talk to Farm Flag (any before last flag works).

<Menu>

##### Upgrade Attributes
- Lune: +18 Might (32)
- Sciel: +43 Might (43), +2 Agility (2)
...
- Lune: Ice Lance
- Gustav: Skip
- Sciel: Attack / Tint Self if 0 AP generated.
...
He will do 1 of first 3 moves into ritual into Sword of Light. You need to Counter both moves!
> The exception is if he targets Lune, you can Parry 2/3 of the hits and dodge the rest (needs 4AP after Lampmaster moves). If you get this, replace Gustave Tint with Gustave Attack.
...
##### Upgrade Attributes
- Lune: +6 Agility (10)
- Verso: +31 Might (31), +11 Agility (11)
...
##### Upgrade Attributes
- **If Recoat:** Lune: Recoat, +11/14 Agility (14 if LVL20), +37 Agility, +9 Luck
- Verso: +18 Agility (29)
- Maelle: +18 Might (50)
- Sciel: +3 Agility (5), +12 Luck (12)
...
- Sciel: _If 58 Might +3 Might (61)_, +6 Luck (18)
