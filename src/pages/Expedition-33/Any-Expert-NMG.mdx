...
Attack > Parry > Overcharge > Parry > Attack
...
#### Demineur, Trumpet Guy, Gault (0:16)
...
- Sciel: Equip Card Weaver Right-Bottom, Equip Twilight Slash Right-Top, Equip Sealed Fate Right-Middle
...
##### Turn 0
- Verso: Attack > Berserk Slash (Watch damage, if getting crits fail QTEs on other abilities to adjust)
- Lune: Elemental Trick
...
> You can Berserk Slash & Sealed Fate fail QTE instead. Just gotta tune damage with QTEs based of Berserk Slash damage.
