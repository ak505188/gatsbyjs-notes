...
## ATTENTION
This route is outdated in favor of [this route](/Expedition-33/Any-Expert-NMG).
...
- Manor & Old Lumiere flags: After Picto menu, reload most recent autosave to cancel dialogue.
...
- Verso: Attack right one, Berserk Slash right one
...
> Take note if Sciel can't get 60 here. If so, you need to kill the Ballet fight for EXP. I recommend giving Maelle +6 Might (59) as well.
...
**Start battle with attack** with a group of 2 or 3 Ballets. 2 is faster, 3 gives more XP. 
The attack prevents Verso getting a 2nd turn before they move.

If Sciel is LVL26, you can run away with the 2nd party. If not, you need to kill until Sciel is LVL26 (should only take 1 fight).
